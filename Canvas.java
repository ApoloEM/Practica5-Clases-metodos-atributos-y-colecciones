...
public class Canvas
{
    ...
    public static Canvas getCanvas()
    {
        if(canvasSingleton == null) {
            canvasSingleton = new Canvas("Juego de Cartas - Práctica 6", 1100, 700, 
                                         new Color(40, 114, 51));
        }
    ...
    public void drawString(String text, int x, int y, String color, int fontSize) {
        ...
        // Crea una nueva fuente con el tamaño deseado
    ...
    public void drawRotatedString(String text, int x, int y, double angleDegrees, String color, int fontSize) {
        ...
        Font oldFont = graphic.getFont();
        // Crea y establece la nueva fuente
        Font newFont = oldFont.deriveFont((float)fontSize);
        graphic.setFont(newFont);
        
        setForegroundColor(color);
        java.awt.geom.AffineTransform oldTransform = graphic.getTransform();
        
        graphic.translate(x, y);
        graphic.rotate(Math.toRadians(angleDegrees));
    ...
    public void setForegroundColor(String colorString)
    {
        ...
        /*else if(colorString.equals("darkGreen")) {
            graphic.setColor(new Color(40, 114, 51));
        }*/
